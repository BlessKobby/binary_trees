...
/**
 * binary_tree_is_heap - Function to check if a binary tree is a valid
 *			Max Binary Heap.
...
/**
 * btih_helper - Helper function to check if a binary tree is a valid
 *		Max Binary Heap.
 * @tree: A pointer to the root node of the tree to check.
 *
 * Return: 1 if tree is a valid Max Binary Heap.
...
/**
 * binary_tree_is_complete - Fucntion to check if a binary tree is complete.
 * @tree: A pointer to the root node of the tree to check.
 *
