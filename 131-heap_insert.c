...
/**
 * heap_insert - Function to insert a value in Max Binary Heap.
...
heap_t *heap_insert(heap_t **root, int value)
{
	...
	for (level = 0, sub = 1; leaves >= sub; sub *= 2, level++)
		leaves -= sub;
	/* subtract all nodes but for bottom-most level */
	...
	/* It flips values with parent until parent value exceeds new value */
